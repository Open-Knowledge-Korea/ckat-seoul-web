...
}else{return SimileAjax.DOM.createDOMFromString(B,"<div class='exhibit-text-facet'><input type='text' id='input' style=\"color:RGB(192,192,192);\" value='검색어를 입력하세요' onFocus=\"this.value='';\"></div>");
}};
...
}else{if(B!="id"){if(B=="class"){if(SimileAjax.Platform.browser.isIE){B="class";
...
D.className=SimileAjax.Platform.browser.isIE?"exhibit-thumbnailView-itemContainer":"exhibit-thumbnailView-itemContainer";
